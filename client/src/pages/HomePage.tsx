    ...
    <>
      ...
      <section className="hero">
        <div className="hero-bg" style={{
          backgroundImage: `url('/assets/rooms/ac-room-tv/1.png')`,
        ...
        <div className="container">
          ...
          <div className="home-rooms-cards">
            <div className="home-room-card glass-card" onClick={() => openBooking('Non-AC')}>
              <div className="home-room-image" style={{ backgroundImage: `url('/assets/rooms/non-ac/1.png')` }} />
            ...
            <div className="home-room-card glass-card" onClick={() => openBooking('AC')}>
              <div className="home-room-image" style={{ backgroundImage: `url('/assets/rooms/ac-room-tv/1.png')` }} />
              <div className="home-room-info">
                <h3>AC Room</h3>
